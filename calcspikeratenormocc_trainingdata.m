function out = calcspikeratenormocc_trainingdata(processeddatadir, dayindex, behaviorindex, trainingtimes)
% SP 9.12.18
...
FRInfo = getstableclustertimes_gauss(tempindex, spikedatadir, windowsize, mintimestable, 0);
