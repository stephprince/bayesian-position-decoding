...
for i = 1:size(dayindex) 
    ...
    placefields{dayindex(i,1)}{dayindex(i,2)} = applyplacefieldcriteria(spikeratenormocc{dayindex(i,1)}{dayindex(i,2)}, dayindex(i,:), behavioridx, processeddatadir, datadir, ...
...
for i = 1:size(dayindex,1)
    ...
    trainingdata{dayindex(i,1)}{dayindex(i,2)} = calcspikeratenormocc_trainingdata_alltimes(processeddatadir, dayindex(i,:), behavioridx, trainingtimes{dayindex(i,1)}{dayindex(i,2)});
...
for i = 1:size(dayindex,1)
    ...
    testingdata{dayindex(i,1)}{dayindex(i,2)} = calcspikestodecode_testingdata_alltimes(processeddatadir, dayindex(i,:), behavioridx, testingtimes{dayindex(i,1)}{dayindex(i,2)});
