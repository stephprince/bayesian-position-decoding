...
savedfiguresdir = '\\neuro-cloud\labs\singer\Steph\Figures\decoding_5050largebins_PFbin4_peakrate1_maxavgrate10_181128\';
...
for i = 1:size(dayindex) 
    ...
    %apply exclusion criteria
     placefields{dayindex(i,1)}{dayindex(i,2)} = applyplacefieldcriteria(spikeratenormocc{dayindex(i,1)}{dayindex(i,2)}, dayindex(i,:), behavioridx, sessindex, processeddatadir,PFbinsize, datadir,...
        'pyr', celltypedir, 'std', stdthreshold, 'peak', peakratethreshold, 'maxmean',maxmeanratethreshold,'reliability_stabletimes', reliabilitythreshold);
...
%     
%     %plot placefields to see span over track
%     plotplacefields_circular(placefields{dayindex(i,1)}{dayindex(i,2)},dayindex(i,:),savedfiguresdir);
% end
